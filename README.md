...
Download **[latest JAR file](https://github.com/ConvertAPI/convertapi-java/releases/download/v1.2/convertapi-1.2.jar)** and place it in your project library directory.
