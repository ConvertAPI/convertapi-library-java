...
Download *[latest JAR file](https://github.com/ConvertAPI/convertapi-java/releases/download/v1.0/convertapi-1.0.jar)* and place it in your project library directory.
