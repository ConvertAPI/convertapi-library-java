...
Download **[latest JAR file](https://github.com/ConvertAPI/convertapi-java/releases/download/v1.1/convertapi-1.1.jar)** and place it in your project library directory.
